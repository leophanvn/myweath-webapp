		...
		<div>
			...
			>
				...
				>
					...
					<Form.Item
						name="duration"
						label="When do you intend to make your purchase?"
						rules={[
							{
								required: true,
								message: 'Please input!',
					...
					<Form.Item
						name="total"
						label="Please estimate the downpayment, stamp duties, legal costs etc. (SGD)"
						rules={[
							{
								required: true,
								message: 'Please input!',
...
BuyAHome.propTypes = propTypes;

BuyAHome.defaultProps = defaultProps;
