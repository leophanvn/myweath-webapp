...
const Education = (props) => {
	const { onSubmit, onCancel, loading, data } = props;
		...
		<div>
			...
			>
				...
				>
					...
					<Form.Item
						name="duration"
						label="How many years before your child embarks on this education?"
						rules={[
							{
								required: true,
								message: 'Please input!',
					...
					<Form.Item
						name="total"
						label="Please estimate the amount required for school fees, tuition costs, living expenses, etc. (SGD)"
						rules={[
							{
								required: true,
								message: 'Please input!',
