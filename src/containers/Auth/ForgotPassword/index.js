					...
					<div className={classes.leftContent}>
						...
						>
							...
							>
								...
								<p className="text-center mt-4 text-black">An email has been sent to your email address to reset your password.  Please check your email and reset your password before logging in.</p>
				...
				<div className={classes.leftContent}>
					...
					>
						...
						>
							...
							<p className="text-center mb-4">Enter your email address. We will send you a link for you to reset your password.</p>
